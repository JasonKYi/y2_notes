...
By cases on \(c = 0\) and construct the composition for each case. \qed
...
Clearly (M1), (M2) and (M3) satisfies this proposition. \qed
...
The Möbius transformation provides us with a holomorphic bijection from
the upper half plane \(\mathbb{H}\) to the disc. Furthermore, as we
shall see, the resulting mapping is a conformal equivalence with the
explicit formula

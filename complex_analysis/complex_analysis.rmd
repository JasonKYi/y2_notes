...
\end{theorem}
\proof
  As \(z_0 \in \partial \gamma\) where \(\partial \gamma\) is open, there exists 
  some \(r' > 0\) such that \(B_{r'}(z_0) \subseteq \partial \gamma\). 
  ...
  \[\left| \frac{1}{2\pi i}\oint_C \frac{f(z) - f(z_0)}{z - z_0} \dd z\right|
    ...
    = \frac{1}{2\pi} \oint_C \frac{\epsilon}{r} \dd z

...
\begin{definition}[\(\sigma\)-additivity for Premeasures]
  A premeasure \(\tilde{\mu}\) on the algebra \(\mathcal{A}\) on \(X\) is \(\sigma\)-additive 
...
\begin{theorem}[Uniqueness of the Hahn-Carathéodory Extension]
  ...
  \(\tilde{\mu}\) is \(\sigma\)-additive. Then, for all outer measures 
...
\proof
  ...
  \(\sigma\)-additivity of \(\tilde{\mu}\). Let \((S_n) \subseteq \mathcal{A}\) be 
  the sequence as described by the \(\sigma\)-additivity of \(\tilde{\mu}\), 

...
\proof
  ...
  letting \(T : V \to V : v \mapsto A v\), we see that for all \(i\), \(V_i\) is 
...
\(T : V \to V\) and similarly for matrices. Then, the Cayley-Hamilton theorem 
states the famous result that, given a linear map 
\(T : V \to V\), if \(\chi_T\) is the characteristic polynomial of \(T\), then 
...
\begin{lemma}\label{no_proper}
  Let \(T : V \to V\) be a linear map such that there does not exists a proper 
